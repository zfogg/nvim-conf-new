...
require("packer").startup({
  function(use)
    ...
    use({ "b0o/mapx.nvim", config = [[require('rc.mapx')]] })
    -- }}}
    ...
    use({ "tmux-plugins/vim-tmux-focus-events", disable = (vim.g.vscode and not vim.fn.has("nvim")) })
    ...
    use({ "jubnzv/virtual-types.nvim", requires = {
    ...
    use({ "peitalin/vim-jsx-typescript", requires = {
