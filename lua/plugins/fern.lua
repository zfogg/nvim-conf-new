...
local keys = { toggle = "<leader>n<space>", nice = "<leader>nn" }

local function keymaps()
  vim.keymap.set("n", keys.toggle, ":Fern . -drawer -reveal=% -toggle<CR>")
  vim.keymap.set("n", keys.nice, ":Fern . -drawer -wait -reveal=%<BAR>wincmd p<CR>")
end
...
return {
  ...
  init = function()
    vim.cmd([[
    " INFO: depends on fern-renderer-nerdfont.vim
